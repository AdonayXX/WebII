            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    <div class="card-body text-center">
                        <h5 class="card-title">Borrar usuarios</h5>
                        <p class="card-text">Eliminar usuarios de la base de datos.</p>
                        <a href="../admin/user_delete.php" class="btn btn-primary">Ir</a>
                    </div>
                </div>
            </div>
             <div class="col-md-4 mb-4">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <p class="card-text">actualizar usuarios.</p>
                        <a href="../admin/user_management.php" class="btn btn-primary">Ir</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <a href="../admin/property_delete.php" class="btn btn-primary">Ir</a>
                    </div>
                </div>
            </div>
          ...
          <div class="col-md-4 mb-4">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <p class="card-text">Registrar propiedades.</p>
                        <a href="../admin/property_form.php" class="btn btn-primary">Ir</a>
                    </div>
                </div>
            </div> 
            <div class="col-md-4 mb-4">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <a href="../admin/property_list.php" class="btn btn-primary">Ir</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-4">
